...
public class TimeSeriesTest {
    ...
    public void testSubSeries() {
        ...
        TimeSeries temp = new TimeSeries(totalPopulation,1992, 1994);

        List<Integer> expectedYears = new ArrayList<>
                (Arrays.asList(1992, 1994));

        assertThat(temp.years()).isEqualTo(expectedYears);
    }
} 